...
namespace form_entry_mahasiswa
{
    public partial class Form1 : Form
    {
        ...
        {
            listOfMahasiswa.Add(new Mahasiswa { Nim = "17.11.0954", Name = "Mahyosha Muhammad", Gender = "Laki-laki", Born="RIAU",Date="18/12/1997",Alamat="JAKAL" });
        ...
        private void btnUbah_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Silahkan Pilih Data Dahulu", "Peringatan...!!...!!", MessageBoxButtons.OK,
                        MessageBoxIcon.Exclamation);
            }
        }
        private void reset()
        ...
        private void btnHapus_Click(object sender, EventArgs e)
        {
            if (lvwMahasiswa.SelectedItems.Count > 0)
            {
                ...
                var msg = string.Format("Apakah data '{0}' ingin dihapus ?", mhs.Name);
